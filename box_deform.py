...
'''Based on Box_deform 0.2.4 - Author: Samuel Bernou'''
...
class GP_PGT_storeDefault(bpy.types.PropertyGroup) :
...
def register():
    ...
    bpy.types.Scene.boxdeform = bpy.props.PointerProperty(type = GP_PGT_storeDefault)
    register_keymaps()
